...
public class TestRecordWithLogicalTypes extends SpecificRecordBase implements SpecificRecord {
   ...
   */
  public static class Builder extends SpecificRecordBuilderBase<TestRecordWithLogicalTypes>
      implements RecordBuilder<TestRecordWithLogicalTypes> {
    ...
    private Builder(TestRecordWithLogicalTypes.Builder other) {
      super(other);
      if (RecordBuilderBase.isValidValue(fields()[0], other.b)) {
        this.b = data().deepCopy(fields()[0].schema(), other.b);
        fieldSetFlags()[0] = other.fieldSetFlags()[0];
      }
      if (RecordBuilderBase.isValidValue(fields()[1], other.i32)) {
        this.i32 = data().deepCopy(fields()[1].schema(), other.i32);
        fieldSetFlags()[1] = other.fieldSetFlags()[1];
      }
      if (RecordBuilderBase.isValidValue(fields()[2], other.i64)) {
        this.i64 = data().deepCopy(fields()[2].schema(), other.i64);
        fieldSetFlags()[2] = other.fieldSetFlags()[2];
      }
      if (RecordBuilderBase.isValidValue(fields()[3], other.f32)) {
        this.f32 = data().deepCopy(fields()[3].schema(), other.f32);
        fieldSetFlags()[3] = other.fieldSetFlags()[3];
      }
      if (RecordBuilderBase.isValidValue(fields()[4], other.f64)) {
        this.f64 = data().deepCopy(fields()[4].schema(), other.f64);
        fieldSetFlags()[4] = other.fieldSetFlags()[4];
      }
      if (RecordBuilderBase.isValidValue(fields()[5], other.s)) {
        this.s = data().deepCopy(fields()[5].schema(), other.s);
        fieldSetFlags()[5] = other.fieldSetFlags()[5];
      }
      if (RecordBuilderBase.isValidValue(fields()[6], other.d)) {
        this.d = data().deepCopy(fields()[6].schema(), other.d);
        fieldSetFlags()[6] = other.fieldSetFlags()[6];
      }
      if (RecordBuilderBase.isValidValue(fields()[7], other.t)) {
        this.t = data().deepCopy(fields()[7].schema(), other.t);
        fieldSetFlags()[7] = other.fieldSetFlags()[7];
      }
      if (RecordBuilderBase.isValidValue(fields()[8], other.ts)) {
        this.ts = data().deepCopy(fields()[8].schema(), other.ts);
        fieldSetFlags()[8] = other.fieldSetFlags()[8];
      }
      if (RecordBuilderBase.isValidValue(fields()[9], other.dec)) {
  ...
  @SuppressWarnings("unchecked")
  private static final DatumWriter<TestRecordWithLogicalTypes> WRITER$ = (DatumWriter<TestRecordWithLogicalTypes>) MODEL$
  ...
  @SuppressWarnings("unchecked")
  private static final DatumReader<TestRecordWithLogicalTypes> READER$ = (DatumReader<TestRecordWithLogicalTypes>) MODEL$
