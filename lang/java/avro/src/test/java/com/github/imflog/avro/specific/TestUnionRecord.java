...
import com.github.imflog.avro.AvroMissingFieldException;
...
public class TestUnionRecord extends SpecificRecordBase implements SpecificRecord {
  ...
  public static class Builder extends SpecificRecordBuilderBase<TestUnionRecord>
      implements RecordBuilder<TestUnionRecord> {
    ...
    private Builder(Builder other) {
      super(other);
      if (RecordBuilderBase.isValidValue(fields()[0], other.amount)) {
  ...
  @SuppressWarnings("unchecked")
  private static final DatumWriter<TestUnionRecord> WRITER$ = (DatumWriter<TestUnionRecord>) MODEL$
  ...
  @SuppressWarnings("unchecked")
  private static final DatumReader<TestUnionRecord> READER$ = (DatumReader<TestUnionRecord>) MODEL$
