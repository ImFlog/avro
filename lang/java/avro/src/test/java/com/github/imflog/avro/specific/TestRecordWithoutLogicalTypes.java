...
public class TestRecordWithoutLogicalTypes extends SpecificRecordBase implements SpecificRecord {
   ...
   */
  public static class Builder extends SpecificRecordBuilderBase<TestRecordWithoutLogicalTypes>
      implements RecordBuilder<TestRecordWithoutLogicalTypes> {
    ...
    private Builder(TestRecordWithoutLogicalTypes other) {
      ...
      if (RecordBuilderBase.isValidValue(fields()[9], other.ts)) {
        this.dec = data().deepCopy(fields()[9].schema(), other.dec);
        fieldSetFlags()[9] = true;
      }
    }
