...
public class TestSchemaValidation {
  ...
  public static final List<TestSchemas.ReaderWriter> COMPATIBLE_READER_WRITER_TEST_CASES = TestSchemas.list(
      ...
      new TestSchemas.ReaderWriter(TestSchemas.NULL_INT_ARRAY_UNION_SCHEMA, TestSchemas.INT_ARRAY_SCHEMA),
  ...
  public static final Schema recursiveSchema = new Schema.Parser().parse(
