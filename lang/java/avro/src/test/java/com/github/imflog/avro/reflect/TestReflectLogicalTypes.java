...
import com.github.imflog.avro.data.TimeConversions;
import com.github.imflog.avro.file.DataFileReader;
import com.github.imflog.avro.file.DataFileWriter;
import com.github.imflog.avro.file.FileReader;
...
public class TestReflectLogicalTypes {
  ...
  void decimalBytes() throws IOException {
    ...
    assertEquals("com.github.ImFlog.avro.reflect.TestReflectLogicalTypes", schema.getNamespace(),
  ...
  void reflectedSchemaLocalDateTime() {
    ...
    assertEquals("com.github.ImFlog.avro.reflect", actual.getNamespace(), "Should have the correct record name");
