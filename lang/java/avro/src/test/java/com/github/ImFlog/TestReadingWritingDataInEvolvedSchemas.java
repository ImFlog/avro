...
import com.github.ImFlog.generic.GenericData;
import com.github.ImFlog.generic.GenericDatumReader;
import com.github.ImFlog.generic.GenericDatumWriter;
import com.github.ImFlog.generic.GenericRecord;
import com.github.ImFlog.io.DatumWriter;
import com.github.ImFlog.io.Decoder;
import com.github.ImFlog.io.DecoderFactory;
import com.github.ImFlog.io.Encoder;
...
public class TestReadingWritingDataInEvolvedSchemas {
  ...
  public void doubleWrittenWithUnionSchemaIsConvertedToDoubleSchema() throws Exception {
    ...
    GenericData.Record record = defaultRecordWithSchema(writer, FIELD_A, 42.0);
    byte[] encoded = encodeGenericBlob(record);
    GenericData.Record decoded = decodeGenericBlob(DOUBLE_RECORD, writer, encoded);
  ...
  public void longWrittenWithUnionSchemaIsConvertedToUnionLongFloatSchema() throws Exception {
    ...
    GenericData.Record record = defaultRecordWithSchema(writer, FIELD_A, 42L);
    byte[] encoded = encodeGenericBlob(record);
    GenericData.Record decoded = decodeGenericBlob(UNION_LONG_FLOAT_RECORD, writer, encoded);
  ...
  public void longWrittenWithUnionSchemaIsConvertedToDoubleSchema() throws Exception {
    ...
    GenericData.Record record = defaultRecordWithSchema(writer, FIELD_A, 42L);
    byte[] encoded = encodeGenericBlob(record);
    GenericData.Record decoded = decodeGenericBlob(UNION_DOUBLE_RECORD, writer, encoded);
    assertEquals(42.0, decoded.get(FIELD_A));
  }
  ...
  public void intWrittenWithUnionSchemaIsConvertedToDoubleSchema() throws Exception {
    ...
    GenericData.Record record = defaultRecordWithSchema(writer, FIELD_A, 42);
    byte[] encoded = encodeGenericBlob(record);
    GenericData.Record decoded = decodeGenericBlob(UNION_DOUBLE_RECORD, writer, encoded);
    assertEquals(42.0, decoded.get(FIELD_A));
  }
  ...
  public void intWrittenWithUnionSchemaIsReadableByFloatSchema() throws Exception {
    ...
    GenericData.Record record = defaultRecordWithSchema(writer, FIELD_A, 42);
    byte[] encoded = encodeGenericBlob(record);
    GenericData.Record decoded = decodeGenericBlob(FLOAT_RECORD, writer, encoded);
  ...
  public void intWrittenWithUnionSchemaIsReadableByFloatUnionSchema() throws Exception {
    ...
    GenericData.Record record = defaultRecordWithSchema(writer, FIELD_A, 42);
    byte[] encoded = encodeGenericBlob(record);
    GenericData.Record decoded = decodeGenericBlob(UNION_FLOAT_RECORD, writer, encoded);
    assertEquals(42.0f, decoded.get(FIELD_A));
  }
  ...
  public void longWrittenWithUnionSchemaIsConvertedToFloatDoubleUnionSchema() throws Exception {
    ...
    GenericData.Record record = defaultRecordWithSchema(writer, FIELD_A, 42L);
    byte[] encoded = encodeGenericBlob(record);
    GenericData.Record decoded = decodeGenericBlob(UNION_FLOAT_DOUBLE_RECORD, writer, encoded);
    assertEquals(42.0F, decoded.get(FIELD_A));
  }
  ...
  public void floatWrittenWithUnionSchemaIsNotConvertedToLongSchema() throws Exception {
    ...
    Schema writer = UNION_INT_LONG_FLOAT_DOUBLE_RECORD;
    GenericData.Record record = defaultRecordWithSchema(writer, FIELD_A, 42.0f);
    byte[] encoded = encodeGenericBlob(record);
  ...
  public void intWrittenWithUnionSchemaIsConvertedToAllNumberSchemas() throws Exception {
    ...
    GenericData.Record record = defaultRecordWithSchema(writer, FIELD_A, 42);
    byte[] encoded = encodeGenericBlob(record);
    Assert.assertEquals(42.0, decodeGenericBlob(DOUBLE_RECORD, writer, encoded).get(FIELD_A));
    Assert.assertEquals(42.0f, decodeGenericBlob(FLOAT_RECORD, writer, encoded).get(FIELD_A));
    Assert.assertEquals(42L, decodeGenericBlob(LONG_RECORD, writer, encoded).get(FIELD_A));
    Assert.assertEquals(42, decodeGenericBlob(INT_RECORD, writer, encoded).get(FIELD_A));
  }
  ...
  public void utf8StringWrittenWithUnionSchemaIsConvertedToBytesSchema() throws Exception {
    ...
    Schema writer = UNION_STRING_BYTES_RECORD;
    GenericData.Record record = defaultRecordWithSchema(writer, FIELD_A, goeran);
    byte[] encoded = encodeGenericBlob(record);
    ByteBuffer actual = (ByteBuffer) decodeGenericBlob(BYTES_RECORD, writer, encoded).get(FIELD_A);
  ...
  public void asciiBytesWrittenWithUnionSchemaIsConvertedToStringSchema() throws Exception {
    ...
    GenericData.Record record = defaultRecordWithSchema(writer, FIELD_A, buf);
    byte[] encoded = encodeGenericBlob(record);
  ...
  public void enumRecordCanBeReadWithExtendedEnumSchema() throws Exception {
    ...
    GenericData.Record record = defaultRecordWithSchema(writer, FIELD_A, new GenericData.EnumSymbol(writer, "A"));
    byte[] encoded = encodeGenericBlob(record);
    GenericData.Record decoded = decodeGenericBlob(ENUM_ABC_RECORD, writer, encoded);
  ...
  public void enumRecordWithExtendedSchemaCanBeReadWithOriginalEnumSchemaIfOnlyOldValues() throws Exception {
    ...
    GenericData.Record record = defaultRecordWithSchema(writer, FIELD_A, new GenericData.EnumSymbol(writer, "A"));
    byte[] encoded = encodeGenericBlob(record);
    GenericData.Record decoded = decodeGenericBlob(ENUM_AB_RECORD, writer, encoded);
    assertEquals("A", decoded.get(FIELD_A).toString());
  }
  ...
  public void enumRecordWithExtendedSchemaCanNotBeReadIfNewValuesAreUsed() throws Exception {
    ...
    Schema writer = ENUM_ABC_RECORD;
    GenericData.Record record = defaultRecordWithSchema(writer, FIELD_A, new GenericData.EnumSymbol(writer, "C"));
    byte[] encoded = encodeGenericBlob(record);
  ...
  public void recordWrittenWithExtendedSchemaCanBeReadWithOriginalSchemaButLossOfData() throws Exception {
    ...
    byte[] encoded = encodeGenericBlob(record);
    GenericData.Record decoded = decodeGenericBlob(INT_RECORD, writer, encoded);
  ...
  public void readerWithoutDefaultValueThrowsException() throws Exception {
    ...
    Schema reader = SchemaBuilder.record(RECORD_A) //
        ...
        .name(FIELD_A).type().intType().noDefault() //
        .endRecord();
    GenericData.Record record = defaultRecordWithSchema(INT_RECORD, FIELD_A, 42);
    byte[] encoded = encodeGenericBlob(record);
  ...
  public void readerWithDefaultValueIsApplied() throws Exception {
    ...
    GenericData.Record record = defaultRecordWithSchema(INT_RECORD, FIELD_A, 42);
    byte[] encoded = encodeGenericBlob(record);
    GenericData.Record decoded = decodeGenericBlob(reader, INT_RECORD, encoded);
    assertEquals(42, decoded.get(FIELD_A));
