...
import com.github.imflog.avro.file.DataFileStream;
import com.github.imflog.avro.file.DataFileWriter;
import com.github.imflog.avro.file.FileReader;
import com.github.imflog.avro.file.SeekableFileInput;
import com.github.imflog.avro.file.SeekableInput;
...
public class TestDataFileReader {
  ...
  void throttledInputStream() throws IOException {
    ...
    Assertions.assertEquals("TestSchema", r.getSchema().getName());
    ...
    Assertions.assertEquals("TestSchema", r2.getSchema().getName());
  }
  ...
  void ignoreSchemaValidationOnRead() throws IOException {
    ...
    try (DataFileStream<Void> r = new DataFileStream<>(new FileInputStream(f), new GenericDatumReader<>())) {
      Assertions.assertEquals(legacySchema, r.getSchema());
    }
  }
