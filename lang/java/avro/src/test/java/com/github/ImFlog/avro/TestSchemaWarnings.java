...
public class TestSchemaWarnings {
  ...
  void warnWhenTheLogicalTypeIsOnTheField() {
    ...
    s.getField("a1").addProp(LogicalType.LOGICAL_TYPE_PROP, LogicalTypes.date().getName());
    assertThat(s.getField("a1").schema().getLogicalType(), nullValue());
    ...
    s.getField("a1").schema().addProp(LogicalType.LOGICAL_TYPE_PROP, LogicalTypes.date().getName());
    assertThat(s.getField("a1").schema().getLogicalType(), nullValue());
