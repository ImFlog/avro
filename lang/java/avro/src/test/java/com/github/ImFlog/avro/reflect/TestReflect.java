...
import com.github.ImFlog.avro.AvroRuntimeException;
import com.github.ImFlog.avro.AvroTypeException;
import com.github.ImFlog.avro.JsonProperties;
...
import com.github.ImFlog.avro.Protocol;
...
import com.github.ImFlog.avro.reflect.TestReflect.SampleRecord.AnotherSampleRecord;
...
public class TestReflect {
  ...
  void unionWithEnum() {
    Schema s = new Schema.Parser().parse("[\"null\", {\"type\":\"enum\",\"name\":\"E\",\"namespace\":"
        + "\"com.github.ImFlog.avro.reflect.TestReflect\",\"symbols\":[\"A\",\"B\"]}]");
    GenericData data = ReflectData.get();
  ...
  void noPackage() throws Exception {
    ...
    Assertions.assertEquals(noPackage.getName(), ReflectData.getClassName(s));
  }
  ...
  void record() throws Exception {
    check(R.class,
        "{\"type\":\"record\",\"name\":\"R\",\"namespace\":"
            + "\"com.github.ImFlog.avro.reflect.TestReflect\",\"fields\":[" + "{\"name\":\"a\",\"type\":\"int\"},"
            + "{\"name\":\"b\",\"type\":\"long\"}]}");
  }
  ...
  void annotationAvroIgnore() throws Exception {
    check(RAvroIgnore.class, "{\"type\":\"record\",\"name\":\"RAvroIgnore\",\"namespace\":"
        + "\"com.github.ImFlog.avro.reflect.TestReflect\",\"fields\":[]}");
  }
  ...
  void annotationAvroName() throws Exception {
    check(RAvroName.class, "{\"type\":\"record\",\"name\":\"RAvroName\",\"namespace\":"
        + "\"com.github.ImFlog.avro.reflect.TestReflect\",\"fields\":[" + "{\"name\":\"b\",\"type\":\"int\"}]}");
  }
  ...
  void annotationAvroStringableFields() throws Exception {
    check(RAvroStringableField.class, "{\"type\":\"record\",\"name\":\"RAvroStringableField\",\"namespace\":"
        + "\"com.github.ImFlog.avro.reflect.TestReflect\",\"fields\":[" + "{\"name\":\"a\",\"type\":\"string\"}]}");
  }
  ...
  void avroEncodeInducing() throws IOException {
    ...
    assertEquals(schm.toString(),
        "{\"type\":\"record\",\"name\":\"AvroEncRecord\",\"namespace"
            + "\":\"com.github.ImFlog.avro.reflect.TestReflect\",\"fields\":[{\"name\":\"date\","
  ...
  void recordWithNullIO() throws IOException {
    ...
    Assertions.assertEquals(a, decoded);
    decoded = reader.read(null, d);
    Assertions.assertEquals(b, decoded);
  }
  ...
  void avroAliasOnClass() {
    check(AliasA.class,
        "{\"type\":\"record\",\"name\":\"AliasA\",\"namespace\":\"com.github.ImFlog.avro.reflect.TestReflect\",\"fields\":[],\"aliases\":[\"b.a\"]}");
    check(AliasB.class,
        "{\"type\":\"record\",\"name\":\"AliasB\",\"namespace\":\"com.github.ImFlog.avro.reflect.TestReflect\",\"fields\":[],\"aliases\":[\"a\"]}");
    check(AliasC.class,
        "{\"type\":\"record\",\"name\":\"AliasC\",\"namespace\":\"com.github.ImFlog.avro.reflect.TestReflect\",\"fields\":[],\"aliases\":[\"a\"]}");
  }
  ...
  void multipleAliasAnnotationsOnClass() {
    check(MultipleAliasRecord.class,
        "{\"type\":\"record\",\"name\":\"MultipleAliasRecord\",\"namespace\":\"com.github.ImFlog.avro.reflect.TestReflect\",\"fields\":[],\"aliases\":[\"space1.alias1\",\"space2.alias2\"]}");
  ...
  void dollarTerminatedNamespaceCompatibility() {
    ...
    Schema s = new Schema.Parser().setValidate(false).parse(
        "{\"type\":\"record\",\"name\":\"Z\",\"namespace\":\"com.github.ImFlog.avro.reflect.TestReflect$\",\"fields\":[]}");
  ...
  void dollarTerminatedNestedStaticClassNamespaceCompatibility() {
    ...
    Schema s = new Schema.Parser().setValidate(false).parse(
        "{\"type\":\"record\",\"name\":\"AnotherSampleRecord\",\"namespace\":\"com.github.ImFlog.avro.reflect.TestReflect$SampleRecord\",\"fields\":[]}");
    assertThat(data.getSchema(data.getClass(s)).getFullName(),
        is("com.github.ImFlog.avro.reflect.TestReflect.SampleRecord.AnotherSampleRecord"));
  }
  ...
  void avroAliasOnField() {
    ...
    Schema expectedSchema = SchemaBuilder.record(ClassWithAliasOnField.class.getSimpleName())
        .namespace("com.github.ImFlog.avro.reflect.TestReflect").fields().name("primitiveField").aliases("aliasName")
  ...
  public void testMultipleFieldAliases() {
    ...
    Schema avroMultiMeta = Schema.createRecord("ClassWithMultipleAliasesOnField", null,
        "com.github.ImFlog.avro.reflect.TestReflect", false, Arrays.asList(field));
  ...
  public void testOptional() {
    check(OptionalTest.class,
        "{\"type\":\"record\",\"name\":\"OptionalTest\","
            + "\"namespace\":\"com.github.ImFlog.avro.reflect.TestReflect\",\"fields\":["
  ...
  void avroDoc() {
    check(DocTest.class,
        "{\"type\":\"record\",\"name\":\"DocTest\",\"namespace\":\"com.github.ImFlog.avro.reflect.TestReflect\","
