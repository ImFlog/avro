  ...
  static void resetFieldAccess() {
    ...
    try {
      if (null == System.getProperty("avro.disable.unsafe")) {
        FieldAccess unsafeAccess = load("com.github.ImFlog.avro.reflect.FieldAccessUnsafe", FieldAccess.class);
    ...
    if (access == null) {
      try {
        FieldAccess reflectAccess = load("com.github.ImFlog.avro.reflect.FieldAccessReflect", FieldAccess.class);
